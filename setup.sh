...
sudo pacman -S --noconfirm  wget gnome-shell firefox albert steam cups gnome-tweak-tool code
...
yay -S --noconfirm micro ferdi spotify jetbrains-toolbox evdi displaylink zotero freetube texstudio
